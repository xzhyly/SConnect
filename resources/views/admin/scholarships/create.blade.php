...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="section-title mb-0 mt-1">Add Scholarship</h4>
            <small class="text-muted">Manually add a scholarship from any organization.</small>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm" style="border-radius:14px;">
                <div class="card-body p-4">
                    ...
                    <div class="alert mb-4 d-flex align-items-center gap-2"
                        ...
                        <span>This scholarship will be tagged as <strong>Manual</strong> and will not be overwritten by API
                            sync.</span>
                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="title" value="{{ old('title') }}"
                                    ...
                                    placeholder="e.g. SM Foundation Scholarship Program"
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                @error('organization_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted" style="font-size:0.75rem;">This will appear as the scholarship
                                    provider.</small>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <small class="text-muted" style="font-size:0.75rem;">
                                    PH scale: 1.00 = highest, 3.00 = passing. Lower number = better grade.
                                </small>
                                @error('minimum_gwa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
            ...
            'BSCRIM' => 'BSCRIM — BS Criminology',
                                        ...
                                        <option value="{{ $code }}"
                                            {{ old('required_course') === $code ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" rows="3" class="form-control @error('description') is-invalid @enderror"
                                    placeholder="Brief description of the scholarship..." style="border-radius:8px;font-size:0.85rem;">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="benefits" rows="2" class="form-control @error('benefits') is-invalid @enderror"
                                    placeholder="e.g. Full tuition, ₱5,000 monthly stipend..." style="border-radius:8px;font-size:0.85rem;">{{ old('benefits') }}</textarea>
                                @error('benefits')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-2 border-top">
                            ...
                            <button type="submit" class="btn btn-success px-5" style="border-radius:8px;">
